<?php
    ...
    $sql_desayunos = mysqli_query($conexion, "SELECT * FROM tipos_usuario WHERE estado=1");
...
<head>
    ...
    <title>Listar - tipos de usuario</title>
            ...
            <tbody>
                <?php while($datos = mysqli_fetch_array($sql_desayunos)){ ?>
                    <tr>
                        ...
                        <td>
                            <a href="modificar_tipos_usuarios.php?id=<?php echo $datos['id_tipo']; ?>"
